# PersonaClick reusable Github Workflows
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/deploy-node-trigger.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/deploy-node.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/deploy-php.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/deploy-ruby.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/docker-publish.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/repo-sync.yaml@master
    with:
      # ...
```
...
| `SIGNING_SECRET_KEY_RING_FILE`          | no       | `com.personaclick.key.gpg`    | Location and name for signature file      |
...
| `GRADLE_VERSION`                        | no       | ``                      |                                           |
| `VARIANT_NAME`                          | yes      | ``                      | PersonaClick or PersonaClick                    |
| `URL`                                   | yes      | ``                      | GitHub repo URL                           |
| `MAVEN_REPOSITORY_URL`                  | yes      | ``                      | Maven repository publish to               |
| `OSSRH_USERNAME`                        | no       | `github-bot@personaclick.com` |                                           |
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-android-google-play-publish.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-deploy-docker.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-docker-publish-infrastructure.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-docker-publish.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-checks-ansible.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-checks-elasticsearch.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-checks-haproxy.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-checks-k8s.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-checks-nginx.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-checks-pgbouncer.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-manual-ansible-check.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-infrastructure-manual-ansible-run.yaml@master
    with:
      # ...
```
...
| name                         | required | default                                  | description |
| ---------------------------- | -------- | ---------------------------------------- | ----------- |
| `googleServicesFileLocation` | no       | `./DemoApp/PersonaClickDemo/Supporting Files/` |             |
...
| name              | required | default          | description                      |
| ----------------- | -------- | ---------------- | -------------------------------- |
| `podSpecFilePath` | no       | `PersonaClick.podspec` | File path to podspec file        |
| `appId`           | yes      | ``               | App token for committing changes |
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-issue-management.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-js-checks.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-js-docker.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-js-publish.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-js-version.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-php-checks.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-php-docker-publish.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-pr-check-only-from-branch.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-ruby-checks.yaml@master
    with:
      # ...
```
...
jobs:
  build:
    uses: personaclick/workflow/.github/workflows/reusable-ruby-publish-migrated-db.yaml@master
    with:
      # ...
```
